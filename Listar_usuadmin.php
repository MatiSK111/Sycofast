...
<tr>
                            ...
                            <td><a href="Editar_usuadmin.php?Rut=<?php echo $datos['rut']?>"class="btn btn-primary" type="button">Editar</a></td>
                            <td><a href="Eliminar_usuadmin.php?Rut=<?php echo $datos['rut']?>"class="btn btn-primary" type="button">Eliminar</a></td>
