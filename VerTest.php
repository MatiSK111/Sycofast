...
<div class="col-10 offset-1" style="padding-bottom:500px">
                <div class="card bg-primary shadow-soft text-center border-light">
                    ...
                    <div class="d-flex justify-content-around">
                            ...
                            <div class="p-2"><h1 style="color:rgb(120,120,171);" >Test Dispinibles</h1></div>
                            <div class="p-2 ">
                                ...
                                <div class="mb-5">
                                    <table class="table shadow-soft rounded">
                                        <tr>
                                            ...
                                            <th class="border-0" scope="col">Ver</th>
                ...
                ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $datos['idtest']?></td>
                                            <td><?php echo $datos['nombre test']?></td>
                                            ...
                                            <td><?php if ($datos['estado']==1){
                                                ...
                                                ?></td>
                                          <td><a href="Verpreguntas.php?id=<?php echo $datos['idtest']?>"class="btn btn-primary" type="button">Ver Test</a></td>
