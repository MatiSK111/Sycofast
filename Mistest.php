...
<div class="col-10 offset-1" style="padding-bottom:500px">
                <div class="card bg-primary shadow-soft text-center border-light">
                    ...
                    <div class="row">
                            <div class="col-4"><a href="Menupaciente.php" class="btn  btn-primary" type="button"><img src="assets\img\iconos\left-arrow.png" height ="30" width="30" /></a></div>
                            <div class="col-4"><h1 style="color:rgb(120,120,171);" >Resultados Test</h1></div>
                            <div class="col-4">
...
<div class="section  text-dark section-lg" >
            ...
            <br>
                ...
                <div class="mb-5">
                    <table class="table shadow-soft rounded">
                        <tr>
                            <th class="border-0" scope="col">Id Test</th>
   ...
   while($datos=mysqli_fetch_array($result)){
    ...
    $sql2="SELECT * FROM test where idtest=".$datos['idtest'];
   ...
   ?>
                        ...
                        <tr>
                            ...
                            <td><?php echo $datos2['nombre test']?></td>
